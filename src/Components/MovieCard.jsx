export default function MovieCard({movieData}){
  ...
  return (
    <div className="wrapperCard relative w-[80rem] h-[30rem] rounded-2xl overflow-hidden m-[auto] shadow-lg shadow-cyan-600" > 
      ...
      <div className="wrapperThumbnailImageAndMetadata absolute bg-gradient-to-r from-gray-800 to-gray-950 opacity-[.9] text-gray-300 max-w-[40rem] flex flex-col pb-[1rem] p-[2rem] h-[100%] justify-between rounded-bl-lg">
        <div className="wrapperThumbnailAndDescription flex gap-[2rem]">
          <div className="wrapperThumbnailImage min-w-[15rem] max-w-[25rem] h-[17rem]">
          ...
          <div className="flex flex-col gap-[.8rem]">
            <h2 className="movieTitle text-[2rem]">{movieData.title}</h2>
            <div className="text-blue-300">
              {movieData.releaseYear}, {movieData.director}
            </div>
            <div className="wrapperRunningTimeAndGenre flex gap-[1rem] items-center">
